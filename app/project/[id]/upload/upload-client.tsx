...
export function UploadClient({ initialDataExists, initialRowCount }: UploadClientProps) {
  ...
  const [dataExists, setDataExists] = useState(initialDataExists);
  const [existingRowCount, setExistingRowCount] = useState(initialRowCount);
  ...
  async function handleUpload() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setResult(data);
        setDataExists(true);
        setExistingRowCount(data.rowCount);
