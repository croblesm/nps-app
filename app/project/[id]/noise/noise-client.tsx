...
import { X, Plus, Trash2, Eye, Pencil, ChevronRight } from "lucide-react";
...
interface NoiseClientProps {
  initialFilters: NoiseFilterData[];
  projectId: string;
}

export function NoiseClient({ initialFilters, projectId }: NoiseClientProps) {
  const [filters, setFilters] = useState<NoiseFilterData[]>(initialFilters);
